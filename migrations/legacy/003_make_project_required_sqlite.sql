-- Migration: 003_make_project_required
-- Description: Make project_id required for integrations (SQLite version)
-- Date: 2024-11-29

PRAGMA foreign_keys=off;

-- Create new table with project_id as NOT NULL
...
-- Copy data from old table (only integrations with project_id)
